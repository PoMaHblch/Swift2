  ...
  // }
   ...
   func tableView(_ tableView: UITableView, commit editingStyle: UITableViewCell.EditingStyle, forRowAt indexPath: IndexPath) {
        if editingStyle == .delete {
            ...
            let frendy = friends[indexPath.row]
          //  let initialSection = sortedFriend.keys.count
            
            friend.removeAll() {$0.name == frendy.name}
           
            
         //   if initialSection - sortedFriend.keys.count == 0 {
