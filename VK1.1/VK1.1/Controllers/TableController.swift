...
class TableController: UITableViewController {
    ...
    @IBAction func addSelectedGrops(segue: UIStoryboardSegue) {
       if let sourceVC = segue.source as? ALLViewController,
    ...
    var groups = [
        Group(image: UIImage.init(systemName: "person.badge.plus"), name: "Знакомства"),
        Group(image: UIImage.init(systemName: "4k.tv"), name: "Кинопоиск"),
        Group(image: UIImage.init(systemName: "car.2"), name: "БашДТП"),
        Group(image: UIImage.init(systemName: "logo.xbox"), name: "XboX"),
    ]
